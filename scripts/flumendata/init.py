...
from .utils import Colors, load_env_file, ensure_dir, print_banner
...
def init_data_dirs():
    ...
    print()
    print(f"{Colors.GREEN}[init] ✓ Data directories created successfully{Colors.RESET}")
    print()
...
def init_superset():
    ...
    # Run command and ignore error if database already exists
